    ...
    <group>
      ...
      <mesh position={[-4, 0, 0]}>
        ...
        <Html position={[0, 0, 0.1]} center transform>
          <div className="w-32 h-40 bg-white p-2 text-black text-[10px] font-mono break-words overflow-hidden border-2 border-[#737373]">
      ...
      <group ref={tunnelRef} position={[0, 0, 0]} rotation={[0, Math.PI / 2, 0]}>
        ...
        <Html position={[0, 1.8, 0]} center>
          <div className="text-[#165D9E] font-bold font-mono bg-black/50 px-2 py-1 rounded border border-[#165D9E]">
            SHA-256
          </div>
        </Html>
      </group>
      ...
      <Html position={[0, -4, 0]} center zIndexRange={[100, 0]}>
        <div className="glass-panel p-4 w-[500px]">
          ...
          <input
            ...
            className="w-full bg-black/50 text-white px-3 py-2 rounded border border-white/20 focus:outline-none focus:border-[#165D9E] font-mono"
          />
        </div>
      </Html>
    </group>
